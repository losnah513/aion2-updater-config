...
for(const token of [
  ...
  'kinojo_sanctuary_management_write_access_v446','kinojo_sanctuary_management_bootstrap_v450',
  'kinojo_sanctuary_management_command_v450','kinojo_sanctuary_management_lease_v446',
...
for(const token of [
  'const API_VERSION=2','const SCHEMA_VERSION=450','sourceRollout',
...
for(const page of ['sanctuary/index.html','m/sanctuary/index.html']){
  ...
  for(const token of [
    'id="sanctuaryManagementWriteMeta"','sanctuary-management.js?cache=2026083020',
