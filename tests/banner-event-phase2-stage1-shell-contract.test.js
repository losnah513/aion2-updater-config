...
assert.ok(loader.includes('v2026082610'),'phase-2 stage-7 loader generation missing');
assert.ok(desktop.includes('admin.js?cache=2026082610'),'desktop loader generation mismatch');
assert.ok(mobile.includes('admin.js?cache=2026082610'),'mobile loader generation mismatch');
