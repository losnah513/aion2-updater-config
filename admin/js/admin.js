/* KINOJO Admin modular loader v2026090804 */
(function(){
  'use strict';
  const current=document.currentScript;
  const currentUrl=new URL(current?.src||location.href,location.href);
  const base=new URL('./',currentUrl);
  const CACHE=String(currentUrl.searchParams.get('cache')||'2026090804').trim()||'2026090804';
  ...
  function loadScript(name){
    ...
    const promise=new Promise((resolve,reject)=>{
      ...
      const characterRevision=['admin-characters.js','admin-bootstrap.js'].includes(name)?'&character=2026090802&automation=2026090801&completion=2026090801&family=2026090901&statusTabs=2026090903&activity=2026090901&exclusions=2026090901&inactive=2026090901&runtimeRetention=2026092401':'';
