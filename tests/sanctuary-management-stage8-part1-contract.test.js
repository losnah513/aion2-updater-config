...
for(const token of ['const API_VERSION="2.2"','const DATABASE_CONTRACT="454"','bootstrap_v454','public_bootstrap_v454','command_v454'])assert.ok(edge.includes(token),`Stage 8 Edge contract missing ${token}`);
for(const token of [
