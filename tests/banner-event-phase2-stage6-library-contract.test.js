...
assert.ok(desktop.includes('admin.js?cache=2026082803')&&mobile.includes('admin.js?cache=2026082803'),'PC/mobile must share the current admin loader generation');
