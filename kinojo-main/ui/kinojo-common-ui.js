...
(function(){
  ...
  function pageInfo(){
    ...
    if(path.includes('/hall-of-fame/'))return {key:'hall',label:'명예의 전당',root:'../kinojo-main/'};
    if(path.includes('/sanctuary/'))return {key:'sanctuary',label:'성역',root:'../kinojo-main/'};
  ...
  function makeDrawer(info){
    ...
    const sanctuaryPrefix=isSanctuary?'./index.html':'../sanctuary/index.html';
