...
assert.ok(desktop.includes('admin.js?cache=2026082703')&&mobile.includes('admin.js?cache=2026082703'),'PC/mobile must share the current admin loader generation');
