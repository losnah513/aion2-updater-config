...
for(const token of ['const API_VERSION=2.5','const SCHEMA_VERSION=480',"params.get('view')==='schedule'",'sanctuaryManagementSchedulePanel','completed:sourceTransition.completed===true',"transitionReview.stage7State!=='COMPLETE'",'review.completed']){
