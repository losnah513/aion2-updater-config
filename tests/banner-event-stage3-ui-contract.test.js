...
assert.ok(loader.includes('v2026090803'),'current admin loader cache generation missing');
assert.ok(desktop.includes('admin.js?cache=2026090803'),'desktop admin cache mismatch');
assert.ok(mobile.includes('admin.js?cache=2026090803'),'mobile admin cache mismatch');
