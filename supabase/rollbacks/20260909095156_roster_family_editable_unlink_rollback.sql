...
-- DB478: keep unowned Sanctuary characters GUEST while changing canonical family roots.
...
drop function public.kinojo_roster_family_save_v487(text,text,bigint,bigint[],jsonb,bigint[]);
drop function private.kinojo_roster_family_save_v487(bigint,text,bigint,bigint[],jsonb,bigint[]);
