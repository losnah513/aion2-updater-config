...
const documentMock={
  readyState:'loading',
  currentScript:{src:'https://kinojo.info/ui/kinojo-pc-banners.js?cache=2026090902'},
...
assert.ok(hofHtml.includes('kinojo-pc-banners.js?cache=2026090902'), 'HOF PC slot sizing script is missing');
