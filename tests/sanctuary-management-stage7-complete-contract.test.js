...
for(const token of [
  ...
  'kinojo_sanctuary_management_month_v452','kinojo_sanctuary_management_command_v453',
...
for(const token of ['const API_VERSION=2.2','const SCHEMA_VERSION=453',"params.get('view')==='schedule'",'sanctuaryManagementSchedulePanel','completed:sourceTransition.completed===true',"transitionReview.stage7State!=='COMPLETE'",'review.completed']){
