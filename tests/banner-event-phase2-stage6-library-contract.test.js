...
assert.ok(desktop.includes('admin.js?cache=2026090708')&&mobile.includes('admin.js?cache=2026090708'),'PC/mobile must share the current admin loader generation');
