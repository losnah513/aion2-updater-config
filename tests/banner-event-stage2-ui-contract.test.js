...
assert.ok(desktop.includes('admin.js?cache=2026082901'),'desktop admin cache generation mismatch');
assert.ok(mobile.includes('admin.js?cache=2026082901'),'mobile admin cache generation mismatch');
