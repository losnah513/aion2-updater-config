...
assert.ok(desktop.includes('admin.js?cache=2026090803')&&mobile.includes('admin.js?cache=2026090803'),'PC/mobile must share the current admin loader generation');
