...
for(const token of [
  ...
  'kinojo_sanctuary_management_rollout_state_v446','kinojo_sanctuary_management_bootstrap_v454',
...
for(const token of ['const API_VERSION=2.2','const SCHEMA_VERSION=454',"params.get('view')==='schedule'",'sanctuaryManagementSchedulePanel','completed:sourceTransition.completed===true',"transitionReview.stage7State!=='COMPLETE'",'review.completed']){
