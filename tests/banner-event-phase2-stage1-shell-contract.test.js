...
assert.ok(loader.includes('v2026082607'),'phase-2 stage-6 loader generation missing');
assert.ok(desktop.includes('admin.js?cache=2026082607'),'desktop loader generation mismatch');
assert.ok(mobile.includes('admin.js?cache=2026082607'),'mobile loader generation mismatch');
