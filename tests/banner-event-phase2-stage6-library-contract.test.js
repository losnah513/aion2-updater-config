...
assert.ok(desktop.includes('admin.js?cache=2026090801')&&mobile.includes('admin.js?cache=2026090801'),'PC/mobile must share the current admin loader generation');
