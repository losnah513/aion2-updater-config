...
assert.ok(loader.includes("2026090803"),'loader cache generation not bumped');
assert.ok(desktop.includes('admin.js?cache=2026090803'),'desktop admin cache generation mismatch');
assert.ok(mobile.includes('admin.js?cache=2026090803'),'mobile admin cache generation mismatch');
