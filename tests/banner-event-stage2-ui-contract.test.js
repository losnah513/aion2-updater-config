...
assert.ok(loader.includes("2026082609"),'loader cache generation not bumped');
assert.ok(desktop.includes('admin.js?cache=2026082609'),'desktop admin cache generation mismatch');
assert.ok(mobile.includes('admin.js?cache=2026082609'),'mobile admin cache generation mismatch');
