...
assert.ok(desktop.includes('admin.js?cache=2026082705'),'desktop admin cache mismatch');
assert.ok(mobile.includes('admin.js?cache=2026082705'),'mobile admin cache mismatch');
