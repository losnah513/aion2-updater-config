...
(function(){
  ...
  function loadScript(name){
    ...
    const promise=new Promise((resolve,reject)=>{
      ...
      const characterRevision=['admin-characters.js','admin-bootstrap.js'].includes(name)?'&character=2026090802&automation=2026090801&completion=2026090801&family=2026090901':'';
