(function(root,factory){
  ...
  const slots=deepFreeze({
    ...
    FRONT:{
      slot:'FRONT',
      label:'전신 정면',
      guideAssetPath:'/assets/images/my-info/guides/front-2x3.png',
      outputWidth:800,
      outputHeight:1200,
      aspectWidth:2,
      aspectHeight:3,
    ...
    BACK:{
      slot:'BACK',
      label:'전신 후면',
      guideAssetPath:'/assets/images/my-info/guides/back-2x3.png',
      outputWidth:800,
      outputHeight:1200,
      aspectWidth:2,
      aspectHeight:3,
    ...
    UPPER_BODY:{
      slot:'UPPER_BODY',
      label:'상반신',
      guideAssetPath:'/assets/images/my-info/guides/upper-body-4x5.png',
      outputWidth:800,
      outputHeight:1000,
      aspectWidth:4,
      aspectHeight:5,
