...
assert.ok(loader.includes('v2026090803'),'current admin loader generation missing');
assert.ok(desktop.includes('admin.js?cache=2026090803'),'desktop loader generation mismatch');
assert.ok(mobile.includes('admin.js?cache=2026090803'),'mobile loader generation mismatch');
