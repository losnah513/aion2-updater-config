...
for(const token of [
  'const API_VERSION="2.2"','const DATABASE_CONTRACT="452"','WRITE_ACTIONS',
  'kinojo_sanctuary_management_rollout_state_v446','kinojo_sanctuary_management_bootstrap_v452',
  'kinojo_sanctuary_management_month_v452','kinojo_sanctuary_management_command_v452',
...
for(const token of ['const API_VERSION=2.2','const SCHEMA_VERSION=452',"params.get('view')==='schedule'",'sanctuaryManagementSchedulePanel','completed:sourceTransition.completed===true',"transitionReview.stage7State!=='COMPLETE'",'review.completed']){
