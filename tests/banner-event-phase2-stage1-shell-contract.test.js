...
assert.ok(loader.includes('v2026082606'),'phase-2 stage-5 loader generation missing');
assert.ok(desktop.includes('admin.js?cache=2026082606'),'desktop loader generation mismatch');
assert.ok(mobile.includes('admin.js?cache=2026082606'),'mobile loader generation mismatch');
