...
for (const entry of ['admin/index.html', 'm/admin/index.html']) {
  const html = read(entry);
  for (const token of ['data-admin-subtab="logs"', 'id="meterDungeonLogRows"', 'id="meterDungeonLogChannel"', 'id="meterDungeonLogQuery"', 'METER RUNTIME LOG', '미터기 실행', '미터기 종료', 'kinojo-supabase-features.js?cache=2026081705', 'admin.js?cache=2026081701']) {
