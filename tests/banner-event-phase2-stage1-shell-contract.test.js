...
assert.ok(loader.includes('v2026082703'),'current admin loader generation missing');
assert.ok(desktop.includes('admin.js?cache=2026082703'),'desktop loader generation mismatch');
assert.ok(mobile.includes('admin.js?cache=2026082703'),'mobile loader generation mismatch');
