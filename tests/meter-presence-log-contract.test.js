...
for (const entry of ['admin/index.html', 'm/admin/index.html']) {
  const html = read(entry);
  for (const token of ['data-admin-subtab="logs"', 'id="meterDungeonLogRows"', 'id="meterDungeonLogChannel"', 'id="meterDungeonLogQuery"', 'METER RUNTIME LOG', '미터기 실행', '미터기 종료', 'id="characterAutomationToggle"', 'KST 22:00 · 04:00 · 10:00 · 16:00', 'kinojo-supabase-features.js?cache=2026083102', 'admin.js?cache=2026082901', '성역 팀 운영', '시트 동기화 종료']) {
