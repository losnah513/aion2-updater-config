...
assert.ok(loader.includes('v2026082608'),'stage-7 loader cache generation missing');
assert.ok(desktop.includes('admin.js?cache=2026082608'),'desktop stage-7 cache mismatch');
assert.ok(mobile.includes('admin.js?cache=2026082608'),'mobile stage-7 cache mismatch');
