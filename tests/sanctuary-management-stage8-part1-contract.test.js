...
for(const token of ['const API_VERSION="2.2"','const DATABASE_CONTRACT="453"','bootstrap_v452','public_bootstrap_v452','command_v453'])assert.ok(edge.includes(token),`Stage 8 Edge contract missing ${token}`);
for(const token of [
