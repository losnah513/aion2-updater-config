...
assert.ok(desktop.includes('admin.js?cache=2026090708'),'desktop loader generation mismatch');
assert.ok(mobile.includes('admin.js?cache=2026090708'),'mobile loader generation mismatch');
