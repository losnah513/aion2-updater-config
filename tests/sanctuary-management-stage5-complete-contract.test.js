...
for(const token of [
  'const API_VERSION="2.2"','const DATABASE_CONTRACT="454"','"archive-preview"',
  'kinojo_sanctuary_management_bootstrap_v454','kinojo_sanctuary_management_month_v454',
...
for(const token of [
  'const API_VERSION=2.2','const SCHEMA_VERSION=454','sanctuary-management-calendar-grid',
