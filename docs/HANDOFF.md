...
- Stage 0~5 제품 기준은 PR `#241`, `#242`, `#244`, `#245`, `#246`, `#248`, `#250`이며, 현재 제품 main은 merge `d96dcfca2cccca7083827b1d27d78846165fcba5`다.
...
- 기존 숫자 우선순위는 노출 횟수를 제어하지 않았으므로 UI에서 제거했다. 새 `기본 | ×1.5 | ×2.0`은 Server playlist 비율로 반영한다. 운영은 API1.9/DB396/Event396/Upload394다.
