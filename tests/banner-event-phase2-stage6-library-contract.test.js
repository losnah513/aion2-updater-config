...
assert.ok(desktop.includes('admin.js?cache=2026090804')&&mobile.includes('admin.js?cache=2026090804'),'PC/mobile must share the current admin loader generation');
