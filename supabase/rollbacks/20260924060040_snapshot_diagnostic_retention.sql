-- Future cleanup rollback only. Removed detail requires external encrypted backup.
begin read write;
...
$function$
;
drop function private.kinojo_snapshot_diagnostic_cleanup_v508(boolean,integer);
drop function private.kinojo_snapshot_diagnostic_candidates_v508(bigint,integer);
drop function private.kinojo_snapshot_diagnostic_cache_v508(jsonb);
commit;
