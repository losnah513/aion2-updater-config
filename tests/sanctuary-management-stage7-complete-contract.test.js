...
for(const token of [
  'const API_VERSION="2.4"','const DATABASE_CONTRACT="458"','WRITE_ACTIONS',
...
for(const token of ['const API_VERSION=2.4','const SCHEMA_VERSION=458',"params.get('view')==='schedule'",'sanctuaryManagementSchedulePanel','completed:sourceTransition.completed===true',"transitionReview.stage7State!=='COMPLETE'",'review.completed']){
