...
const context={
  window:{KinojoSupabase:{
    async searchSanctuaryManagementCharacter(teamId,query){calls.push({kind:'search',teamId,query});return query==='공식'?{ok:true,schemaVersion:436,source:'OFFICIAL',candidate:official}:{ok:true,schemaVersion:436,source:'CHARACTER_MASTER',character:master};},
