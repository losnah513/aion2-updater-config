...
assert.ok(loader.includes('v2026082605'),'phase-2 stage-4 loader generation missing');
assert.ok(desktop.includes('admin.js?cache=2026082605'),'desktop loader generation mismatch');
assert.ok(mobile.includes('admin.js?cache=2026082605'),'mobile loader generation mismatch');
