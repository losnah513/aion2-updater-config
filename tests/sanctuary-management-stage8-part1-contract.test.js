...
for(const token of ['const API_VERSION="2.5"','const DATABASE_CONTRACT="480"','bootstrap_v456','public_bootstrap_v456','command_v454'])assert.ok(edge.includes(token),`Stage 8 Edge contract missing ${token}`);
for(const token of [
