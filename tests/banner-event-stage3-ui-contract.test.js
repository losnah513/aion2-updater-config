...
assert.ok(loader.includes('v2026090801'),'current admin loader cache generation missing');
assert.ok(desktop.includes('admin.js?cache=2026090801'),'desktop admin cache mismatch');
assert.ok(mobile.includes('admin.js?cache=2026090801'),'mobile admin cache mismatch');
