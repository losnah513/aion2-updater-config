...
assert.ok(loader.includes('v2026082802'),'current admin loader cache generation missing');
assert.ok(desktop.includes('admin.js?cache=2026082802'),'desktop admin cache mismatch');
assert.ok(mobile.includes('admin.js?cache=2026082802'),'mobile admin cache mismatch');
