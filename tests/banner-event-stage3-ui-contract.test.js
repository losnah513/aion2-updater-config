...
assert.ok(loader.includes('v2026082901'),'current admin loader cache generation missing');
assert.ok(desktop.includes('admin.js?cache=2026082901'),'desktop admin cache mismatch');
assert.ok(mobile.includes('admin.js?cache=2026082901'),'mobile admin cache mismatch');
