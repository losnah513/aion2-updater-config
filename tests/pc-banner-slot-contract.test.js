...
const documentMock={
  readyState:'loading',
  currentScript:{src:'https://kinojo.info/ui/kinojo-pc-banners.js?cache=2026090708'},
...
assert.ok(hofHtml.includes('kinojo-pc-banners.js?cache=2026090708'), 'HOF PC slot sizing script is missing');
