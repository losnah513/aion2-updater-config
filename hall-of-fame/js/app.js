...
function openAdminDropdown(){const box=document.getElementById("adminDropdown");if(!box)return;box.classList.toggle("open");box.setAttribute("aria-hidden",box.classList.contains("open")?"false":"true")}
