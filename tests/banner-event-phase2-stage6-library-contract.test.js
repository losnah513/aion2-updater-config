...
assert.ok(desktop.includes('admin.js?cache=2026082804')&&mobile.includes('admin.js?cache=2026082804'),'PC/mobile must share the current admin loader generation');
